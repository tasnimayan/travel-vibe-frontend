            ...
            <div className="p-3">
              <form onSubmit={handleSearch}>
                ...
                <div className="relative">
                  ...
                  <input type="text" id="input-group-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="search tours" />
                </div>
              </form>
            </div>
          </li>
