    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <ol className="relative border-s border-gray-200 dark:border-gray-700">                  
          <li className="mb-10 ms-6">            
              ...
              <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">First Day</h3>
          ...
          <li className="mb-10 ms-6">
              ...
              <h3 className="mb-1 text-lg font-semibold text-gray-900 dark:text-white">Second Day</h3>
          ...
          <li className="ms-6">
              ...
              <h3 className="mb-1 text-lg font-semibold text-gray-900 dark:text-white">Third Day</h3>
