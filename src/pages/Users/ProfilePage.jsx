    ...
    <div>
      <div className="mx-4 mt-24 bg-white shadow-xl rounded-lg text-gray-900">
        ...
        <div className="mx-auto w-32 h-32 relative -mt-16 border-4 border-white rounded-full overflow-hidden">
            <img className="object-cover object-center h-32" src='https://img.freepik.com/free-vector/businessman-character-avatar-isolated_24877-60111.jpg?w\u003d2000' alt='Woman looking front'/>
        </div>
        <div className="text-center mt-2">
            <h2 className="font-semibold">Travel Vibe Official</h2>
            <p className="text-gray-500">Travel Agency Based on BD</p>
        </div>
